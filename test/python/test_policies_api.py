...
from conjur.api import PoliciesApi
...
class TestPoliciesApi(api_config.ConfiguredTest):
    ...
    def setUpClass(cls):
        ...
        cls.alice_api = PoliciesApi(alice_client)

    def setUp(self):
        self.api = PoliciesApi(self.client)
        self.bad_auth_api = PoliciesApi(self.bad_auth_client)
    ...
    def test_replace_policy_201(self):
        ...
        """
        response = self.api.replace_policy_with_http_info(self.account, 'root', TEST_POLICY)
    ...
    def test_update_policy_201(self):
        ...
        """
        response = self.api.update_policy_with_http_info(self.account, 'root', MODIFY_POLICY)
    ...
    def test_load_policy_201(self):
        ...
        """
        response = self.api.load_policy_with_http_info(self.account, 'root', UPDATE_POLICY)
