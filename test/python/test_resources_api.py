...
class TestResourcesApi(api_config.ConfiguredTest):
    ...
    def test_show_for_account_400(self):
        ...
        """
        with self.assertRaises(conjur.ApiException) as context:
            self.api.show_for_account(NULL_BYTE)

        self.assertEqual(context.exception.status, 400)

    def test_show_for_account_401(self):
        """Test case for 401 status response on /resources/{account} endpoint
        401 - unauthorized request
        """
        with self.assertRaises(conjur.ApiException) as context:
            self.bad_auth_api.show_for_account(self.account)

        self.assertEqual(context.exception.status, 401)

    def test_show_for_account_403(self):
        """Test case for 403 status response on /resources/{account} endpoint
        403 - the authenticated user lacks the necessary privilege
        """
        with self.assertRaises(conjur.ApiException) as context:
            self.api.show_for_account(self.account, acting_as="user:alice")

        self.assertEqual(context.exception.status, 403)

    def test_show_for_account_422(self):
        """Test case for 422 status response on /resources/{account} endpoint
        422 - Conjur received a malformed request parameter
        """
        with self.assertRaises(conjur.ApiException) as context:
            self.api.show_for_account(self.account, kind=NULL_BYTE)

        self.assertEqual(context.exception.status, 422)

    # Test cases for /resources/{account}/{kind} endpoint

    def test_show_for_account_and_kind_200(self):
        """Test case for 200 status response on /resources/{account}/{kind}
        200 - successful request, resources returned as JSON
        """
        response = self.api.show_for_account_and_kind_with_http_info(
            self.account,
            "variable"
        )
    ...
    def test_show_for_account_and_kind_400(self):
        ...
        """
        with self.assertRaises(conjur.ApiException) as context:
            self.api.show_for_account_and_kind(NULL_BYTE, "variable")

        self.assertEqual(context.exception.status, 400)

    def test_show_for_account_and_kind_401(self):
        """Test case for 401 status response on /resources/{account}/{kind} endpoint
        401 - unauthorized request
        """
        with self.assertRaises(conjur.ApiException) as context:
            self.bad_auth_api.show_for_account_and_kind(self.account, "variable")

        self.assertEqual(context.exception.status, 401)

    def test_show_for_account_and_kind_403(self):
        """Test case for 403 status response on /resources/{account}/{kind} endpoint
        403 - the authenticated user lacks the necessary privilege
        """
        with self.assertRaises(conjur.ApiException) as context:
            self.api.show_for_account_and_kind(
                self.account,
                "variable",
    ...
    def test_show_for_account_kind_and_id_204(self):
    ...
    def test_show_for_account_kind_and_id_400(self):
        ...
        """
        with self.assertRaises(conjur.ApiException) as context:
            self.api.show_for_account_kind_and_id(self.account, NULL_BYTE, 'testSecret')

        self.assertEqual(context.exception.status, 400)

    def test_show_for_account_kind_and_id_401(self):
        """Test case for 401 status response on /resources/{account}/{kind}/{identifier} endpoint
        401 - unauthorized request
        """
        with self.assertRaises(conjur.ApiException) as context:
            self.bad_auth_api.show_for_account_kind_and_id(self.account, 'variable', 'testSecret')

        self.assertEqual(context.exception.status, 401)

    def test_show_for_account_kind_and_id_403(self):
        ...
        """
        with self.assertRaises(conjur.ApiException) as context:
            self.api.show_for_account_kind_and_id(
                self.account,
                'variable',
                'testSecret',
                check='',
    ...
    def test_show_for_account_kind_and_id_404a(self):
        """Test case for 404 status response on /resources/{account}/{kind}/{identifier} endpoint
        404 - the requested resource does not exist
        """
        with self.assertRaises(conjur.ApiException) as context:
            self.api.show_for_account_kind_and_id(self.account, 'variable', 'fakeVariable')

        self.assertEqual(context.exception.status, 404)

    def test_show_for_account_kind_and_id_404b(self):
        """Test case for 404 status response on /resources/{account}/{kind}/{identifier} endpoint
        ...
        with self.assertRaises(conjur.ApiException) as context:
            alice_resource_api.show_for_account_kind_and_id_with_http_info(
                self.account,
                'variable',
                'testSecret'
            )
    ...
    def test_show_for_account_kind_and_id_422(self):
    ...
    def test_permitted_roles_and_check(self):
        ...
        """
        response, status, _ = self.api.show_for_account_kind_and_id_with_http_info(
            self.account,
            'variable',
            'testSecret',
            permitted_roles='',
