...
ACCOUNT_NAME="dev"
LOGIN="admin"
ADMIN_API_KEY=$CONJUR_ADMIN_API_KEY

new_password="N3w-Passw0rd!"
secret="supersecretstuff"
secret_id="sampleSecret"

chmod +x /src/client.sh
/src/client.sh getAccessToken --host "https://conjur-https" --account $ACCOUNT_NAME --login $LOGIN --api-key "$ADMIN_API_KEY"
